...
"{{b}}Notice!{{/b}} User registration is disabled in your WordPress network settings, and new sites can't be created from this form. Visitors can still submit this form, but no new user accounts or sites will be created. To enable user registration, go to {{link}}Network Admin → Settings → Allow new registrations{{/link}}." => array( null, __("{{b}}Notice!{{/b}} User registration is disabled in your WordPress network settings, and new sites can't be created from this form. Visitors can still submit this form, but no new user accounts or sites will be created. To enable user registration, go to {{link}}Network Admin → Settings → Allow new registrations{{/link}}.", "forminator"), ), // src/global/components/notice.js:34
"{{b}}Notice!{{/b}} Site registration is disabled in your WordPress network settings. Visitors can still submit this form and user accounts will be created, but no new sites will be created. To enable site registration, go to {{link}}Network Admin → Settings → Allow new registrations{{/link}}." => array( null, __("{{b}}Notice!{{/b}} Site registration is disabled in your WordPress network settings. Visitors can still submit this form and user accounts will be created, but no new sites will be created. To enable site registration, go to {{link}}Network Admin → Settings → Allow new registrations{{/link}}.", "forminator"), ), // src/global/components/notice.js:43
"{{b}}Notice!{{/b}} Site registration is only available on the network's main site. Visitors can still submit this form and user accounts will be created, but no new sites will be created." => array( null, __("{{b}}Notice!{{/b}} Site registration is only available on the network's main site. Visitors can still submit this form and user accounts will be created, but no new sites will be created.", "forminator"), ), // src/global/components/notice.js:49
"{{b}}Notice!{{/b}} User registration is disabled in your WordPress network settings. Visitors can still submit this form, but no new user accounts will be created. To enable registration, go to {{link}}Network Admin → Settings → Allow new registrations{{/link}}." => array( null, __("{{b}}Notice!{{/b}} User registration is disabled in your WordPress network settings. Visitors can still submit this form, but no new user accounts will be created. To enable registration, go to {{link}}Network Admin → Settings → Allow new registrations{{/link}}.", "forminator"), ), // src/global/components/notice.js:56
"{{b}}Notice!{{/b}} User registration is disabled in your WordPress settings. Visitors can still submit this form, but no new user accounts will be created. To enable registration, go to {{link}}Settings → General → Membership{{/link}}." => array( null, __("{{b}}Notice!{{/b}} User registration is disabled in your WordPress settings. Visitors can still submit this form, but no new user accounts will be created. To enable registration, go to {{link}}Settings → General → Membership{{/link}}.", "forminator"), ), // src/global/components/notice.js:62
...
"Bulgarian (bg)" => array( null, __("Bulgarian (bg)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:321
"Croatian (hr)" => array( null, __("Croatian (hr)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:322
"Czech (cs)" => array( null, __("Czech (cs)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:323
"Estonian (et)" => array( null, __("Estonian (et)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:327
"Filipino (fil)" => array( null, __("Filipino (fil)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:328
"Greek (el)" => array( null, __("Greek (el)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:332
"Hungarian (hu)" => array( null, __("Hungarian (hu)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:333
"Indonesian (id)" => array( null, __("Indonesian (id)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:334
"Korean (ko)" => array( null, __("Korean (ko)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:337
"Latvian (lv)" => array( null, __("Latvian (lv)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:338
"Lithuanian (lt)" => array( null, __("Lithuanian (lt)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:339
"Malay (ms)" => array( null, __("Malay (ms)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:340
"Maltese (mt)" => array( null, __("Maltese (mt)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:341
"Norwegian Bokmål (nb)" => array( null, __("Norwegian Bokmål (nb)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:342
"Polish (pl)" => array( null, __("Polish (pl)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:343
"Portuguese (pt)" => array( null, __("Portuguese (pt)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:344
"Romanian (ro)" => array( null, __("Romanian (ro)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:345
"Slovak (sk)" => array( null, __("Slovak (sk)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:347
"Slovenian (sl)" => array( null, __("Slovenian (sl)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:348
"Thai (th)" => array( null, __("Thai (th)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:351
"Turkish (tr)" => array( null, __("Turkish (tr)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:352
"Vietnamese (vi)" => array( null, __("Vietnamese (vi)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:353
"Add your products, services and plans below. You can add multiple products and conditionally process each one based on your form data." => array( null, __("Add your products, services and plans below. You can add multiple products and conditionally process each one based on your form data.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:453
"Note: You'll need to configure conditions on each product to let Forminator know when to process each of the products below." => array( null, __("Note: You'll need to configure conditions on each product to let Forminator know when to process each of the products below.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:474
"There is an error in one or more of your products. Please review the error and try again." => array( null, __("There is an error in one or more of your products. Please review the error and try again.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:501
"Checkout Experience" => array( null, __("Checkout Experience", "forminator"), ), // src/form/components/fields/stripe-ocs.js:531
"Configure customer information and checkout behavior for Stripe Checkout." => array( null, __("Configure customer information and checkout behavior for Stripe Checkout.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:539
"Enhanced Checkout" => array( null, __("Enhanced Checkout", "forminator"), ), // src/form/components/fields/stripe-ocs.js:554
"Standard Checkout" => array( null, __("Standard Checkout", "forminator"), ), // src/form/components/fields/stripe-ocs.js:563
"Customers pay using a compact payment field on your form. " => array( null, __("Customers pay using a compact payment field on your form. ", "forminator"), ), // src/form/components/fields/stripe-ocs.js:568
"Adaptive Pricing" => array( null, __("Adaptive Pricing", "forminator"), ), // src/form/components/fields/stripe-ocs.js:577
"Show prices in your customer's local currency during checkout. Please ensure Adaptive Pricing is enabled in your {{adaptivePricingLink}}Stripe Dashboard{{/adaptivePricingLink}}." => array( null, __("Show prices in your customer's local currency during checkout. Please ensure Adaptive Pricing is enabled in your {{adaptivePricingLink}}Stripe Dashboard{{/adaptivePricingLink}}.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:579
"Your charge currency must be one of your Stripe settlement currencies. If needed, add currencies in {{settlementCurrenciesLink}}Stripe payouts settings{{/settlementCurrenciesLink}} before using Adaptive Pricing." => array( null, __("Your charge currency must be one of your Stripe settlement currencies. If needed, add currencies in {{settlementCurrenciesLink}}Stripe payouts settings{{/settlementCurrenciesLink}} before using Adaptive Pricing.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:603
"Checkout email" => array( null, __("Checkout email", "forminator"), ), // src/form/components/fields/stripe-ocs.js:621
"Use a Forminator Email field to prefill the customer's email in Stripe Checkout. If disabled or left unmapped, Stripe will ask the customer to enter their email during checkout." => array( null, __("Use a Forminator Email field to prefill the customer's email in Stripe Checkout. If disabled or left unmapped, Stripe will ask the customer to enter their email during checkout.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:623
"Email field" => array( null, __("Email field", "forminator"), ), // src/form/components/fields/stripe-ocs.js:633
"Checkout phone (optional)" => array( null, __("Checkout phone (optional)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:650
"Use a Forminator Phone field to prefill the customer's phone number in Stripe Checkout.  If disabled or left unmapped, no phone number will be collected." => array( null, __("Use a Forminator Phone field to prefill the customer's phone number in Stripe Checkout.  If disabled or left unmapped, no phone number will be collected.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:652
"Phone field" => array( null, __("Phone field", "forminator"), ), // src/form/components/fields/stripe-ocs.js:662
"Payment Methods" => array( null, __("Payment Methods", "forminator"), ), // src/form/components/fields/stripe-ocs.js:683
"Choose how customers can pay. The default option allows card payments only. To allow other payment methods like Venmo, Google Pay, or AliPay, select the Dynamic Payment Methods option below." => array( null, __("Choose how customers can pay. The default option allows card payments only. To allow other payment methods like Venmo, Google Pay, or AliPay, select the Dynamic Payment Methods option below.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:691
"Dynamic Payment Methods" => array( null, __("Dynamic Payment Methods", "forminator"), ), // src/form/components/fields/stripe-ocs.js:708
"You’ve selected dynamic payment methods. Please configure accepted payment methods on your {{link}}Stripe Dashboard{{/link}}." => array( null, __("You’ve selected dynamic payment methods. Please configure accepted payment methods on your {{link}}Stripe Dashboard{{/link}}.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:716
"Note: Only payment methods with immediate confirmation are supported." => array( null, __("Note: Only payment methods with immediate confirmation are supported.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:741
"{{link}}Learn more{{/link}}." => array( null, __("{{link}}Learn more{{/link}}.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:743
"Cards Only" => array( null, __("Cards Only", "forminator"), ), // src/form/components/fields/stripe-ocs.js:765
"Use these below options to enable and configure additional options for your Stripe payment." => array( null, __("Use these below options to enable and configure additional options for your Stripe payment.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:844
"Send Payment Receipt" => array( null, __("Send Payment Receipt", "forminator"), ), // src/form/components/fields/stripe-ocs.js:852
"You can enable or disable Payment Receipt emails in your {{link}}Stripe Dashboard{{/link}}. Note that Stripe sends the email receipt only for live payments." => array( null, __("You can enable or disable Payment Receipt emails in your {{link}}Stripe Dashboard{{/link}}. Note that Stripe sends the email receipt only for live payments.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:886
"Choose whether you want Stripe to email a receipt to your customers on successful payment. Note that Stripe sends the email receipt only for live payments." => array( null, __("Choose whether you want Stripe to email a receipt to your customers on successful payment. Note that Stripe sends the email receipt only for live payments.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:893
"Enable Billing Details" => array( null, __("Enable Billing Details", "forminator"), ), // src/form/components/fields/stripe-ocs.js:899
"Customer phone number (optional)" => array( null, __("Customer phone number (optional)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:949
"Select a phone field" => array( null, __("Select a phone field", "forminator"), ), // src/form/components/fields/stripe-ocs.js:951
"Payment Element Layout" => array( null, __("Payment Element Layout", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1063
"Choose the Payment Element’s layout that fits your checkout flow." => array( null, __("Choose the Payment Element’s layout that fits your checkout flow.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1071
"Tabs" => array( null, __("Tabs", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1085
"Accordion with radio buttons" => array( null, __("Accordion with radio buttons", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1094
"Accordion without radio buttons" => array( null, __("Accordion without radio buttons", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1103
"Select a theme from the Stripe Appearance API to control the style of all elements." => array( null, __("Select a theme from the Stripe Appearance API to control the style of all elements.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1136
"Night" => array( null, __("Night", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1145
"Customize Appearance" => array( null, __("Customize Appearance", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1154
"Customize Colors" => array( null, __("Customize Colors", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1161
"Primary color" => array( null, __("Primary color", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1166
"Error" => array( null, __("Error", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1187
"Other options" => array( null, __("Other options", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1195
"Border radius" => array( null, __("Border radius", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1228
...
"In %s" => array( null, __("In %s", "forminator"), ), // src/form/components/fields/paypal.js:106
"You have not connected your PayPal account with Forminator. " => array( null, __("You have not connected your PayPal account with Forminator. ", "forminator"), ), // src/form/components/fields/paypal.js:138
"Connect your PayPal account {{link}}here{{/link}} and then come back to configure this field." => array( null, __("Connect your PayPal account {{link}}here{{/link}} and then come back to configure this field.", "forminator"), ), // src/form/components/fields/paypal.js:143
"Mode of payment" => array( null, __("Mode of payment", "forminator"), ), // src/form/components/fields/paypal.js:166
"We recommend using sandbox mode to ensure the payments are working as expected and when you are ready to start collecting live payments, switch to the {{strong}}Live{{/strong}} payments mode." => array( null, __("We recommend using sandbox mode to ensure the payments are working as expected and when you are ready to start collecting live payments, switch to the {{strong}}Live{{/strong}} payments mode.", "forminator"), ), // src/form/components/fields/paypal.js:170
"Sandbox" => array( null, __("Sandbox", "forminator"), ), // src/form/components/fields/paypal.js:179
"It's recommended to charge in your customers' currency to drive more sales and avoid foreign exchange fee to your customers." => array( null, __("It's recommended to charge in your customers' currency to drive more sales and avoid foreign exchange fee to your customers.", "forminator"), ), // src/form/components/fields/paypal.js:189
"Payment amount" => array( null, __("Payment amount", "forminator"), ), // src/form/components/fields/paypal.js:204
"Fixed" => array( null, __("Fixed", "forminator"), ), // src/form/components/fields/paypal.js:211
"Fixed amount" => array( null, __("Fixed amount", "forminator"), ), // src/form/components/fields/paypal.js:221
"E.g. 20.00" => array( null, __("E.g. 20.00", "forminator"), ), // src/form/components/fields/paypal.js:223
"Enter an amount or choose a form field." => array( null, __("Enter an amount or choose a form field.", "forminator"), ), // src/form/components/fields/paypal.js:225
"Variable" => array( null, __("Variable", "forminator"), ), // src/form/components/fields/paypal.js:234
"Variable amount" => array( null, __("Variable amount", "forminator"), ), // src/form/components/fields/paypal.js:244
"A currency field can be used to take user-defined payments such as donations and calculation field can be used to charge a calculated value based on a formula." => array( null, __("A currency field can be used to take user-defined payments such as donations and calculation field can be used to charge a calculated value based on a formula.", "forminator"), ), // src/form/components/fields/paypal.js:269
"Choose a label for your PayPal button. Note that PayPal checkout doesn't allow a custom label for the PayPal button. You can only choose from the pre-defined labels." => array( null, __("Choose a label for your PayPal button. Note that PayPal checkout doesn't allow a custom label for the PayPal button. You can only choose from the pre-defined labels.", "forminator"), ), // src/form/components/fields/paypal.js:291
"PayPal Checkout" => array( null, __("PayPal Checkout", "forminator"), ), // src/form/components/fields/paypal.js:297
"Pay with PayPal" => array( null, __("Pay with PayPal", "forminator"), ), // src/form/components/fields/paypal.js:298
"PayPal" => array( null, __("PayPal", "forminator"), ), // src/form/components/fields/paypal.js:299
"PayPal recommends using the Gold button since it is widely known as their brand color. However, if that does not suit your theme, you can choose a different color." => array( null, __("PayPal recommends using the Gold button since it is widely known as their brand color. However, if that does not suit your theme, you can choose a different color.", "forminator"), ), // src/form/components/fields/paypal.js:310
"Gold" => array( null, __("Gold", "forminator"), ), // src/form/components/fields/paypal.js:315
"Blue" => array( null, __("Blue", "forminator"), ), // src/form/components/fields/paypal.js:316
"Silver" => array( null, __("Silver", "forminator"), ), // src/form/components/fields/paypal.js:317
"White" => array( null, __("White", "forminator"), ), // src/form/components/fields/paypal.js:318
"Black" => array( null, __("Black", "forminator"), ), // src/form/components/fields/paypal.js:319
"E.g. 250" => array( null, __("E.g. 250", "forminator"), ), // src/form/components/fields/paypal.js:341
"Choose the width of PayPal Smart Buttons. It can be anywhere between 150px to 750px. Leave this empty if you want the buttons to take the full width of the form up to the 750px limit." => array( null, __("Choose the width of PayPal Smart Buttons. It can be anywhere between 150px to 750px. Leave this empty if you want the buttons to take the full width of the form up to the 750px limit.", "forminator"), ), // src/form/components/fields/paypal.js:351
"Choose the height of PayPal Smart Buttons. It can be anywhere between 25px to 55px" => array( null, __("Choose the height of PayPal Smart Buttons. It can be anywhere between 25px to 55px", "forminator"), ), // src/form/components/fields/paypal.js:387
"Shape" => array( null, __("Shape", "forminator"), ), // src/form/components/fields/paypal.js:397
"Choose your preferred shape from your PayPal Smart Buttons." => array( null, __("Choose your preferred shape from your PayPal Smart Buttons.", "forminator"), ), // src/form/components/fields/paypal.js:401
"Rectangular" => array( null, __("Rectangular", "forminator"), ), // src/form/components/fields/paypal.js:405
"Pill" => array( null, __("Pill", "forminator"), ), // src/form/components/fields/paypal.js:406
"We recommend the vertical layout as it allows additional payment methods such as Credit Cards. You can read about the layout options {{link}}here{{/link}}." => array( null, __("We recommend the vertical layout as it allows additional payment methods such as Credit Cards. You can read about the layout options {{link}}here{{/link}}.", "forminator"), ), // src/form/components/fields/paypal.js:417
"Tagline" => array( null, __("Tagline", "forminator"), ), // src/form/components/fields/paypal.js:435
"Choose whether to show the default PayPal tagline {{strong}}\"The safer, easier way to pay\"{{/strong}} below your PayPal button." => array( null, __("Choose whether to show the default PayPal tagline {{strong}}\"The safer, easier way to pay\"{{/strong}} below your PayPal button.", "forminator"), ), // src/form/components/fields/paypal.js:439
"Disable Funding Sources" => array( null, __("Disable Funding Sources", "forminator"), ), // src/form/components/fields/paypal.js:460
"PayPal automatically adds additional funding sources to the PayPal checkout for visitors from supported countries. However, you can choose to disable funding sources which shouldn't be displayed to visitors." => array( null, __("PayPal automatically adds additional funding sources to the PayPal checkout for visitors from supported countries. However, you can choose to disable funding sources which shouldn't be displayed to visitors.", "forminator"), ), // src/form/components/fields/paypal.js:468
"Credit or debit cards" => array( null, __("Credit or debit cards", "forminator"), ), // src/form/components/fields/paypal.js:481
"PayPal Credit" => array( null, __("PayPal Credit", "forminator"), ), // src/form/components/fields/paypal.js:488
"Bancontact" => array( null, __("Bancontact", "forminator"), ), // src/form/components/fields/paypal.js:495
"BLIK" => array( null, __("BLIK", "forminator"), ), // src/form/components/fields/paypal.js:502
"eps" => array( null, __("eps", "forminator"), ), // src/form/components/fields/paypal.js:509
"giropay" => array( null, __("giropay", "forminator"), ), // src/form/components/fields/paypal.js:516
"iDEAL" => array( null, __("iDEAL", "forminator"), ), // src/form/components/fields/paypal.js:523
"Mercado Pago" => array( null, __("Mercado Pago", "forminator"), ), // src/form/components/fields/paypal.js:532
"MyBank" => array( null, __("MyBank", "forminator"), ), // src/form/components/fields/paypal.js:539
"Przelewy24" => array( null, __("Przelewy24", "forminator"), ), // src/form/components/fields/paypal.js:546
"SEPA-Lastschrift" => array( null, __("SEPA-Lastschrift", "forminator"), ), // src/form/components/fields/paypal.js:553
"Sofort" => array( null, __("Sofort", "forminator"), ), // src/form/components/fields/paypal.js:560
"Venmo" => array( null, __("Venmo", "forminator"), ), // src/form/components/fields/paypal.js:567
"Pre-fill Billing Details" => array( null, __("Pre-fill Billing Details", "forminator"), ), // src/form/components/fields/paypal.js:577
"Pre-fill the payer's billing info collected on your form on the Debit or Credit Card checkout, so the payer doesn't have to enter those details again." => array( null, __("Pre-fill the payer's billing info collected on your form on the Debit or Credit Card checkout, so the payer doesn't have to enter those details again.", "forminator"), ), // src/form/components/fields/paypal.js:585
"Ensure the Country option is enabled and required for {{strong}}%(fieldName)s{{/strong}} to process Paypal’s transaction successfully." => array( null, __("Ensure the Country option is enabled and required for {{strong}}%(fieldName)s{{/strong}} to process Paypal’s transaction successfully.", "forminator"), ), // src/form/components/fields/paypal.js:702
"Shipping Address" => array( null, __("Shipping Address", "forminator"), ), // src/form/components/fields/paypal.js:738
"If you are selling a product that doesn't need to be shipped, you can choose to disable and hide the shipping address fields from the PayPal payment page." => array( null, __("If you are selling a product that doesn't need to be shipped, you can choose to disable and hide the shipping address fields from the PayPal payment page.", "forminator"), ), // src/form/components/fields/paypal.js:746
"You can add a description to help you recognise the transactions made on this form." => array( null, __("You can add a description to help you recognise the transactions made on this form.", "forminator"), ), // src/form/components/fields/paypal.js:776
"This appears in your PayPal transaction details and payment notifications." => array( null, __("This appears in your PayPal transaction details and payment notifications.", "forminator"), ), // src/form/components/fields/paypal.js:789
"Up to 127 characters only" => array( null, __("Up to 127 characters only", "forminator"), ), // src/form/components/fields/paypal.js:793
"By default, PayPal detects the language for the visitors based on their geolocation and browser preferences. It is recommended to pass this parameter only if you need the PayPal buttons to render in the same language as the rest of your site. {{link}}Supported locale codes.{{/link}}" => array( null, __("By default, PayPal detects the language for the visitors based on their geolocation and browser preferences. It is recommended to pass this parameter only if you need the PayPal buttons to render in the same language as the rest of your site. {{link}}Supported locale codes.{{/link}}", "forminator"), ), // src/form/components/fields/paypal.js:819
"Eg. en_US" => array( null, __("Eg. en_US", "forminator"), ), // src/form/components/fields/paypal.js:837
"Debug Mode" => array( null, __("Debug Mode", "forminator"), ), // src/form/components/fields/paypal.js:847
"PayPal debug mode helps troubleshoot any issues. However, it's recommended to disable this in production as it causes a significant increase in the script size and performance decrease." => array( null, __("PayPal debug mode helps troubleshoot any issues. However, it's recommended to disable this in production as it causes a significant increase in the script size and performance decrease.", "forminator"), ), // src/form/components/fields/paypal.js:855
